...
\u003cp\u003eStart by downloading the installation file for your plaltform (.exe for windows and .deb for linux). Windows users can run the .exe file and choose where the bot will be installed. Linux users will need a package manager that can run .deb files. GDebi will work for this.\u003c/p\u003e
\u003cblockquote\u003e
...
\u003ch3 id="help"\u003eHelp\u003c/h3\u003e
\u003cp\u003eNeed some assistance? You can recieve support at -\u003c/p\u003e
\u003cul\u003e
...
\u003cp\u003eSettings are properties for your commands. You can restrict thier usage by points or rank. You can also add cooldowns and set a command to run on a set interval.\u003c/p\u003e
...
\u003cp\u003eEnter the name of the channel that you want to join. Note that if you have a bot account you still need to join the streamer chat, \u003cstrong\u003enot\u003c/strong\u003e the bot chat. This is the #1 casue of issues in Glimboi. Join the right channel!\u003c/p\u003e
\u003ch3 id="moving-on"\u003eMoving on\u0026hellip;\u003c/h3\u003e
\u003cp\u003eGlimboi will save every channel you join. You can save an unlimited amount of channels. One channel can be set to autojoin when you load the chat page. Channels can also be removed.\u003c/p\u003e
...
\u003cp\u003eThe position determines which part of the overlay the element will show up in. You enter the x and y values for its position. It will allign the items to the top left of the media element. Audio media do not require any input. Choose the position that works best for you. You should have the overlay be full size of your stream for the best results.\u003c/p\u003e
\u003cblockquote\u003e
...
\u003cblockquote\u003e
\u003cp\u003eFor folder playback it searches downward recursivly which means it scans other folders within the top folder.\u003c/p\u003e
\u003c/blockquote\u003e
...
\u003cp\u003eIf enabled Glimboi will remind you to stretch, drink water, and take a break if neccassary. You can set the interval or turn it off completly.\u003c/p\u003e
...
\u003cp\u003eLet\u0026rsquo;s say you wanted a command to welcome the name of a user when they join your chat. You \u003cem\u003ecould\u003c/em\u003e make a individual welcome command for each user but there is an eaier way. You can use the $target variable which takes the first word after the command trigger.\u003c/p\u003e
...
\u003cp\u003eJoin our yotuube channel at $youtube\u003c/p\u003e
...
`},{id:17,href:"https://glimboi.com/docs/integrations/follow-alerts/",title:"Follow Messages",description:"Doc explaining follow alerts",content:`\u003ch2 id="follow-alerts"\u003eFollow Alerts\u003c/h2\u003e
...
\u003cp\u003eSave your settings when finished.\u003c/p\u003e
\u003cblockquote\u003e
\u003cp\u003eAs spam protection the Glimesh API limits a follower message to once per 6 hours. This prevents a user from following and refollowing to spam the chat with follow messages.\u003c/p\u003e
\u003c/blockquote\u003e
`},{id:18,href:"https://glimboi.com/docs/users/quotes/",title:"Quotes",description:"Doc explaining quotes",content:`\u003ch2 id="quotes-overview"\u003eQuotes Overview\u003c/h2\u003e
\u003cblockquote\u003e
...
`},{id:19,href:"https://glimboi.com/docs/integrations/streamlabs/",title:"Streamlabs Alerts",description:"Doc explaining streamlabs integration",content:`\u003ch2 id="streamlabs-alerts"\u003eStreamlabs Alerts\u003c/h2\u003e
...
\u003cp\u003eClick on the above link and create a new app. Enter the requested info. \u003cstrong\u003eYou must whitelist your own account that is linked to streamlabs\u003c/strong\u003e. It should be in the same casing as your username, not your displayname. The redirect URL must be \u003ccode\u003ehttp://localhost:3000\u003c/code\u003e\u003c/p\u003e
...
`},{id:20,href:"https://glimboi.com/docs/help/troubleshooting/",title:"Troubleshooting",description:"Solutions to common problems.",content:`\u003ch1 id="restart"\u003eRestart\u003c/h1\u003e
...
\u003cp\u003eEnsure the cooldown is turned off or at a low rate. Check that you have the required rank to run the command. You may also need points to run the command. Most of these conditions will alert you in chat if they are not met. You can also check the state of the command (disabled or enabled) as well as the revelant triggers.\u003c/p\u003e
...
\u003cp\u003eFind the .exe file you use to start the bot. Right click, open file location. Run Uninstall.exe . If you wish to delete the bot data you must do so manually. The bot data can be found in the below folder. Deleting this data will completly remove all of your commands, users, ranks, etc. Everything will be lost \u003cstrong\u003eincluding\u003c/strong\u003e the backups!\u003c/p\u003e
...
\u003cli\u003e\u003ca href="https://glimesh.tv/Mytho"\u003eGlimesh.tv/Mytho\u003c/a\u003e\u003c/li\u003e
\u003c/ul\u003e
`},{id:21,href:"https://glimboi.com/docs/help/faq/",title:"FAQ",description:"Answers to frequently asked questions.",content:`\u003ch2 id="how-much-does-glimboi-cost"\u003eHow much does GlimBoi cost?\u003c/h2\u003e
